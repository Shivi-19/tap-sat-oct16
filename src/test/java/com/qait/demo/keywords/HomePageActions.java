...
//		StringBuffer sb = new StringBuffer();
	...
	public void verifyLogo() {
		...
		Assert.assertTrue(element("flipkart_logo").isDisplayed(), "[ASSERT FAILED]: Wrong Url");
		// TODO Auto-generated method stub
		
	}

	public void verify_User_Is_Able_To_View_Ratings() {
		// TODO Auto-generated method stub flipcart_Rating
		Assert.assertTrue(element("flipcart_Rating").isDisplayed(), "[ASSERT FAILED]: Wrong Url");
	}
